            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.mainContainer}>
                    ...
                    <View>
                        ...
                        <Text style={[styles.tableHeaderCell, { width: '9%', borderRight: '1 solid #cbd5e1' }]}>Int. Code</Text>
                        <Text style={[styles.tableHeaderCell, { width: '9%', borderRight: '1 solid #cbd5e1' }]}>Q. No.</Text>
                        <Text style={[styles.tableHeaderCell, { width: '12%', borderRight: '1 solid #cbd5e1' }]}>Product</Text>
                        <Text style={[styles.tableHeaderCell, { width: '12%', borderRight: '1 solid #cbd5e1' }]}>Description</Text>
                        <Text style={[styles.tableHeaderCell, { width: '6%', borderRight: '1 solid #cbd5e1', textAlign: 'right' }]}>Qty</Text>
                        <Text style={[styles.tableHeaderCell, { width: '5%', borderRight: '1 solid #cbd5e1', textAlign: 'center' }]}>Unit</Text>
                        ...
                        <Text style={[styles.tableHeaderCell, { width: '5%', borderRight: '1 solid #cbd5e1', textAlign: 'right' }]}>Srv</Text>
                        ...
                        <Text style={[styles.tableHeaderCell, { width: '11%', textAlign: 'right' }]}>Amount</Text>
                        </View>

                        {items.map((item, i) => (
                            <View style={styles.tableRow} key={i}>
                                <Text style={[styles.tableCell, { width: '4%', borderRight: '1 solid #cbd5e1' }]}>{i + 1}</Text>
                                <Text style={[styles.tableCell, { width: '9%', borderRight: '1 solid #cbd5e1' }]}>{item.internalCode}</Text>
                                <Text style={[styles.tableCell, { width: '9%', borderRight: '1 solid #cbd5e1' }]}>{item.quotationNumber}</Text>
                                <Text style={[styles.tableCell, { width: '12%', borderRight: '1 solid #cbd5e1' }]}>{item.product}</Text>
                                <Text style={[styles.tableCell, { width: '12%', borderRight: '1 solid #cbd5e1' }]}>{item.description}</Text>
                                <Text style={[styles.tableCell, { width: '6%', borderRight: '1 solid #cbd5e1', textAlign: 'right' }]}>{item.quantity}</Text>
                                <Text style={[styles.tableCell, { width: '5%', borderRight: '1 solid #cbd5e1', textAlign: 'center' }]}>{item.unit}</Text>
                                ...
                                <Text style={[styles.tableCell, { width: '5%', borderRight: '1 solid #cbd5e1', textAlign: 'right' }]}>{item.serviceCharge || 0}</Text>
                                ...
                                <Text style={[styles.tableCell, { width: '11%', textAlign: 'right' }]}>{item.amount}</Text>
                            </View>
                        ))}
                    </View>
